...
PROMPT_FILE = os.environ.get("PROMPT_FILE")   # ← start_A_dev.bat がセット
WS_URL = os.environ.get("WS_URL")             # ← "ws://localhost:8000/wsA"
...
print(f"[characterA] PROMPT_FILE loaded: {PROMPT_FILE}")
print(f"[characterA] Connecting to: {WS_URL}")
...
async def connect_and_listen():
    ...
    async with websockets.connect(WS_URL) as ws:
        print("[characterA] Connected:", WS_URL)
        ...
        while True:
            try:
                ...
                print("[characterA] WS disconnected. Reconnecting...")
